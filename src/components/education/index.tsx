...
export const EducationSection: FunctionComponent<IEducationSectionProps> = ({ educationHistory }) => {
	return (
		<TitledSection title="Education">
			{educationHistory.map((e) => {
				const { school, location, bullets } = e;
				return <SectionSummary key={school} left={school} right={location} bullets={bullets} />;
			})}
		</TitledSection>
	);
};
